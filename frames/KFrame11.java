 ...
 * @author Ben
 */
public class KFrame11 extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if (event.getSource() == JTextField) {
            ...
            interpretPrimitiveCommand(text);
    ...
    private void sleep(int n) {
        try {
            ...
            Logger.getLogger(KFrame11.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
